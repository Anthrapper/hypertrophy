    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          InkWell(
            child: Padding(
              padding:  EdgeInsets.fromLTRB(Get.width/ 20,Get.height/ 30,Get.width/5,0),
          ...
          InkWell(
            child: Padding(
              padding:  EdgeInsets.fromLTRB(Get.width/ 20,Get.height/ 40,Get.width/5,0),
              child: Text('Update Body Information'
                ,style: GoogleFonts.sourceSansPro(
                  fontSize: Get.width/25,
                  color: HexColorUtils.getColorFromHex(CustomColors.whiteText),
letterSpacing: 1.6
          ...
          InkWell(
            child: Padding(
              padding:  EdgeInsets.fromLTRB(20,Get.height/ 40,Get.width/5,Get.height/ 40),
              child: Text('Logs'
                ,style:  GoogleFonts.sourceSansPro(
                  fontSize: Get.width/25,
                  color: HexColorUtils.getColorFromHex(CustomColors.whiteText),
