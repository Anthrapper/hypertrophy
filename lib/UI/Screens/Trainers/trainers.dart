...
class _TrainerPageState extends State<TrainerPage> {
  ...
  Widget _search(){
    ...
    return Padding(
      ...
      padding:  EdgeInsets.fromLTRB( Get.width/ 20,Get.height/ 28,Get.width/20,0),
      child: Container(
                ...
                child: Stack(
                  children: <Widget>[
                    Container(
                      ...
                      child: Padding(
                        padding: EdgeInsets.fromLTRB(0, Get.height / 60, 0, 0),
                        child: Column(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(getDocs['Customers'].toString() ?? '',
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(getDocs['Review'].toString() +' reviews)'?? '',
                                    style:  GoogleFonts.lato(
                                      fontSize: Get.width / 28,
                                      letterSpacing: 1.2,
                            ...
                            Padding(
                              ...
                              child: Text(getDocs['Name'], style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: HexColorUtils.getColorFromHex(
                                    CustomColors.whiteText),
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    width: pWidth * 0.15,
                                    child: Text(
                                      'Crossfit', textAlign: TextAlign.center,
